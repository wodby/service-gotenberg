...
Use Gotenberg as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Gotenberg service in the Wodby catalog.

- [Gotenberg service in the Wodby catalog](https://wodby.com/services/gotenberg)
...
4. Reference `gotenberg` from your stack manifest.
